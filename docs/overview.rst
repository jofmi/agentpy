...
- :class:`environment`, :class:`grid` and :class:`network`, which hold agents
- :class:`agent`
...
To design a custom model, these classes can be used as parent classes and be expanded with custom attributes and methods. See :doc:`models` for examples.
