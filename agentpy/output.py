...
class DataDict(AttrDict):
    ...
    Attributes:
        ...
        variables (dict of pandas.DataFrame): Dynamic variables, seperated per object type,
    ...
    def _combine_pars(self):
        ...
        # Take either fixed or varied parameters
            ...
            raise AgentpyError("Parameters must be of type dict, DataDict, or pandas.DataFrame")
...
def load(*args, **kwargs):
    """ Alias of ``DataDict().load(*args,**kwargs)`` """

    return DataDict().load(*args, **kwargs)
